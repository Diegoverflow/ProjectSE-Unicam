...
public class SimpleAddettoBar implements AddettoBar {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Objects.equals(nome, that.nome) && Objects.equals(cognome, that.cognome) && Objects.equals(password, that.password) && Objects.equals(notifiche, that.notifiche) && Objects.equals(ordinazioneBarConsegnate, that.ordinazioneBarConsegnate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, nome, cognome, password, notifiche, ordinazioneBarConsegnate);
    }
}
